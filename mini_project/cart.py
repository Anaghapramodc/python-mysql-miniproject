        ...
        for i in fp:
            ...
            if p in x and q in x:
                ...
                d = {1: 'id_no', 2: 'cust_gmail', 3: 'cust_password', 4: 'cust_name', 5: 'artist_password', 6: 'artist_gmail',
                     ...
                     9: 'size', 10: 'price', 11: 'paiment_ststs', 12: 'artist_name'}
                # print(l)
                dict = {}
                t = 0
                for i in myresult:
                    ...
                    #print(dict)
                    if p==dict.get('cust_gmail') and q==dict.get('cust_password') and dict.get('paiment_ststs')=='NOT SELL':
                            c=1
                            row = 6
                            for i in range(row):
                                for j in range(row):
                ...
                for i in myresult:
                    ...
                    if p==dict.get('cust_gmail') and q==dict.get('cust_password'):
                        mycursor.execute("use art_gallary")
                        sql = "delete from cust_cart where painting_name=" + "'" + pn + "'" + " and " + "artist_name=" + "'" + cb + "'" + " and " + "paiment_ststs=" + "'NOT SELL'"
...
def put_cart():
    ...
    for i in myresult:
        ...
        if  dict.get('painting_name')==n and  dict.get('user_name')==a:
             ...
             s=dict.get('size')
             mycursor.execute("use art_gallary")
             sql = "insert into cust_cart(cust_gmail,cust_password,cust_name,atist_pwd,artist_gmail,painting_name,mediam,size,price,paiment_ststs,artist_name) values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
             val = [
    ...
    for i in myresult:
        ...
        if dict.get('sell_or_not')=='NOT SELL':
            ...
            for i in range(row):
                ...
                if i == 4:
                    print("  ", dict.get('size'), " ", dict.get('mediam'), " ", dict.get('art_code'), end='')
                if i == 5:
                    print("   ----------------------------------------", end='')
                print()
...
def cart():
    ...
    while True:
        ...
        if select == 4:
            from cust_signin_login import start
            start()
            break
